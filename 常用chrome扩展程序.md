...
还有一种直接下载解压zip文件的方法：下载bypass-paywalls-chrome-clean-master.zip文件，[地址在此](https://gitflic.ru/project/magnolia1234/bpc_uploads/blob/raw?file=bypass-paywalls-chrome-clean-master.zip)
